  ...
  if (param.tag === 2) {
    ...
    if (match !== 0) {
      ...
      throw [
            match_failure,
            [
              "/home/johan/code/hangman/node_modules/bucklescript-tea/src/vdom.ml",
              319,
              30
            ]
          ];
...
function update(model, param$$1) {
  switch (param$$1.tag | 0) {
    ...
    case 2 : 
        return /* tuple */[
                start_guessing(param$$1[0], model),
                none
              ];
    case 3 : 
        return /* tuple */[
...
function view_game_over(model, param$$1) {
  if (param$$1 !== 0) {
    return div$2(/* None */0, /* None */0, /* :: */[
...
function view(model) {
  ...
  return $less$pipe((function (param$$1) {
                return div$2(/* None */0, /* None */0, /* [] */0, param$$1);
              }), typeof match === "number" ? (
                match !== 0 ? /* :: */[
                    view_guessing(model),
                    /* [] */0

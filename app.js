...
function track_event(event_category, action, event_label) {
  gtag("event", action, {
...
function track_exception(description) {
...
function guess(g, model) {
  track_event("guessing", "guess", _1(Char$1[/* to_string */5], g));
...
function update(model, param$$1) {
  switch (param$$1.tag | 0) {
    ...
    case 2 : 
        var word = param$$1[0];
        track_view("guessing");
        track_event("guessing", "word", word);
        return /* tuple */[
                start_guessing(word, /* record */[
                      /* state */model[/* state */0],
                      /* word_letters */model[/* word_letters */1],
                      /* guesses */model[/* guesses */2],
                      /* error : None */0
